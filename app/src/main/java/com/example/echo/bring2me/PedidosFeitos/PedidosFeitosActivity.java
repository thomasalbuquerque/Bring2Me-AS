...
import com.example.echo.bring2me.Adapters.PedidosFeitosListAdapter;
...
public class PedidosFeitosActivity extends Activity{
    ...
    public void buscarPedidosFeitos(final String userID){
        ...
        StringRequest pedidoFeitoReq = new StringRequest(Request.Method.POST, AppConfig.URL_PEDIDOSFeitos,
        ...
        AppController.getInstance().addToRequestQueue(pedidoFeitoReq);
