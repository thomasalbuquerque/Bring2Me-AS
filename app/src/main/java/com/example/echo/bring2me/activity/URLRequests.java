...
public class URLRequests {
    ...
    static String URL_ORDER = "http://echob2m.esy.es/bd_api/pedido.php";
    ...
    static String URL_REMOVEVIAGEMCadastrada = "http://echob2m.esy.es/bd_api/deletaViagem.php";

    static String URL_IMAGEM = "http://echob2m.esy.es/verviagem.png";

    static int AvaliacaoPadraoDoViajante = 5;
}